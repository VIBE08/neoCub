...
SRCS = 	mandatory/src/cub3d.c						\
		...
		mandatory/parsing/free_data.c				\
	 	...
	 	mandatory/parsing/init_scene.c				\
...
SRCS_BONUS = bonus/src/cub3d_bonus.c					\
 		...
 		bonus/parsing/utils/helper_functions3_bonus.c	\
  		...
  		bonus/parsing/utils/ft_split2_bonus.c			\
   		bonus/parsing/store_textures_bonus.c			\
   	 	...
   	 	bonus/parsing/init_scene_bonus.c				\
		...
		bonus/raycasting/error_bonus.c
...
$(OBJS): %.o: %.c mandatory/include/cub3d.h
	$(CC) $(FLAGS) -c $< -o $@ 

$(NAME_BONUS): $(OBJS_BONUS)
	$(CC) $(FLAGS) $(OBJS_BONUS)  -o $(NAME_BONUS) $(NEW_MLX)

$(OBJS_BONUS): %.o: %.c bonus/include/cub3d_bonus.h
	$(CC) $(FLAGS) -c $< -o $@ 
